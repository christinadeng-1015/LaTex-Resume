...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Personal website: \href{https://christinadeng.herokuapp.com/}{\textbf {christinadeng.herokuapp.com}} \& \href{https://christinadeng.com/}{christinadeng.com}
...
\item{
 \textbf{Front-end}{: HTML, CSS, Javascript, Angular, Django, Bootstrap, jQuery}
 \hfill
 \textbf{Back-end}{: Python, Flask, Java, SQL}
}
\item{
 \textbf{Analytics}{: R, Python, SQL, VBA, MATLAB, Google Analytics, Excel}
 \hfill
 \textbf{Version Control}{: Github, Bitbucket}
}
\item{
 \textbf{Tools}{: LaTex, OneNote, Contentful, Jira, NPM, JFrog, Abstract, Adobe XD, Photoshop, Illustrator}
}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Honors Bachelor of Science, Mathematics Specialist, Statistics Major \& Economics Minor}{Sep 2015 -- Jun 2018}
    \resumeSubheading
